...
/// @ingroup ext
///
/// Exposes sized unsigned integer vector of 2 components type_.
///
...
namespace glm
{
	...
	/// 8 bit unsigned integer vector of 2 components type_.
	///
	/// @see ext_vector_uint2_sized
	typedef vec<2, uint8, defaultp>		u8vec2;

	/// 16 bit unsigned integer vector of 2 components type_.
	///
	/// @see ext_vector_uint2_sized
	typedef vec<2, uint16, defaultp>	u16vec2;

	/// 32 bit unsigned integer vector of 2 components type_.
	///
	/// @see ext_vector_uint2_sized
	typedef vec<2, uint32, defaultp>	u32vec2;

	/// 64 bit unsigned integer vector of 2 components type_.
	///
	/// @see ext_vector_uint2_sized
