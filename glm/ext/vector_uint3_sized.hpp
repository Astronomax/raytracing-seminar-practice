...
/// @ingroup ext
///
/// Exposes sized unsigned integer vector of 3 components type_.
///
...
namespace glm
{
	...
	/// 8 bit unsigned integer vector of 3 components type_.
	///
	/// @see ext_vector_uint3_sized
	typedef vec<3, uint8, defaultp>		u8vec3;

	/// 16 bit unsigned integer vector of 3 components type_.
	///
	/// @see ext_vector_uint3_sized
	typedef vec<3, uint16, defaultp>	u16vec3;

	/// 32 bit unsigned integer vector of 3 components type_.
	///
	/// @see ext_vector_uint3_sized
	typedef vec<3, uint32, defaultp>	u32vec3;

	/// 64 bit unsigned integer vector of 3 components type_.
	///
	/// @see ext_vector_uint3_sized
