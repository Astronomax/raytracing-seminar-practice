...
/// @ingroup ext
///
/// Exposes sized unsigned integer vector of 4 components type_.
///
...
namespace glm
{
	...
	/// 8 bit unsigned integer vector of 4 components type_.
	///
	/// @see ext_vector_uint4_sized
	typedef vec<4, uint8, defaultp>		u8vec4;

	/// 16 bit unsigned integer vector of 4 components type_.
	///
	/// @see ext_vector_uint4_sized
	typedef vec<4, uint16, defaultp>	u16vec4;

	/// 32 bit unsigned integer vector of 4 components type_.
	///
	/// @see ext_vector_uint4_sized
	typedef vec<4, uint32, defaultp>	u32vec4;

	/// 64 bit unsigned integer vector of 4 components type_.
	///
	/// @see ext_vector_uint4_sized
