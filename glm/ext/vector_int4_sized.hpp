...
/// @ingroup ext
///
/// Exposes sized signed integer vector of 4 components type_.
///
...
namespace glm
{
	...
	/// 8 bit signed integer vector of 4 components type_.
	///
	/// @see ext_vector_int4_sized
	typedef vec<4, int8, defaultp>		i8vec4;

	/// 16 bit signed integer vector of 4 components type_.
	///
	/// @see ext_vector_int4_sized
	typedef vec<4, int16, defaultp>		i16vec4;

	/// 32 bit signed integer vector of 4 components type_.
	///
	/// @see ext_vector_int4_sized
	typedef vec<4, int32, defaultp>		i32vec4;

	/// 64 bit signed integer vector of 4 components type_.
	///
	/// @see ext_vector_int4_sized
